      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex space-x-6">
            <Link href="/" className="flex items-center gap-2 text-gray-700 dark:text-gray-300 hover:text-amber-500 transition"><FaHome /> Home</Link>
            <Link href="/explore" className="flex items-center gap-2 text-gray-700 dark:text-gray-300 hover:text-amber-500 transition"><FaSearch /> Explore</Link>
            <Link href="/feed" className="flex items-center gap-2 text-gray-700 dark:text-gray-300 hover:text-amber-500 transition"><FaTwitter /> Feed</Link>
            <Link href="/research-market" className="flex items-center gap-2 text-gray-700 dark:text-gray-300 hover:text-amber-500 transition"><FaShoppingCart /> Market</Link>
            <Link href="/challenges" className="flex items-center gap-2 text-gray-700 dark:text-gray-300 hover:text-amber-500 transition"><FaBriefcase /> Challenges</Link>
            <Link href="/leaderboard" className="flex items-center gap-2 text-gray-700 dark:text-gray-300 hover:text-amber-500 transition"><FaTrophy /> Leaderboard</Link>
            ...
            {isLoggedIn ? (
              <>
                <Link href="/messages" className="flex items-center gap-2 text-gray-700 dark:text-gray-300 hover:text-amber-500 transition"><FaEnvelope /> Messages</Link>
                <Link href="/profile" className="flex items-center gap-2 text-gray-700 dark:text-gray-300 hover:text-amber-500 transition"><FaUser /> Profile</Link>
              </>
            ) : (
